...
export function Sidebar() {
  ...
  return (
    <>
      {/* Mobile header bar */}
      <div className="fixed top-0 left-0 right-0 z-50 flex h-14 items-center gap-3 border-b px-4 md:hidden border-[#1A1816] bg-[#060606]/95 backdrop-blur-sm">
        <button
          className="flex h-10 w-10 items-center justify-center rounded-lg transition-colors hover:bg-[#1A1816] text-[#E8E4DF]"
      ...
      {mobileOpen && (
        <div
          className="fixed inset-0 z-30 md:hidden transition-opacity bg-[#060606]/60 backdrop-blur-sm"
      ...
      >
        {/* Logo area */}
        <div className="flex h-16 items-center px-7 border-b border-[#1A1816]">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#6B6560]">mc.lookandseen.com</p>
            </div>
          </div>
        </div>
                ...
                >
                  ...
                  <item.icon
                    className={cn(
                      ...
                      isActive ? "text-[#B8956A]" : isUrgent ? "text-red-500" : ""
                    )}
                    strokeWidth={1.5}
                  />
        ...
        {/* Footer */}
        <div className="border-t border-[#1A1816] px-7 py-4">
          <p className="text-[11px] tracking-wide text-[#6B6560]">
